...
class Lunar {
   ...
   public:
    ...
    static int call(lua_State *L, const char *method, int nargs = 0,
                    int nresults = LUA_MULTRET, int errfunc = 0) {
...
#define LUA_EXPORT_CLASS_BEGIN(Class) Lunar<Class>::RegType Class::methods[] = {
#define LUNAR_EXPORT_METHOD(Class, Name) \
    { #Name, &Class::Name }
